# 🫱🏼‍🫲🏼 Contributing to Strip Markdown Headings

Thank you for considering a contribution to Strip Markdown Headings! Whether you're fixing bugs, suggesting improvements, writing docs, or sharing ideas – your input helps the project grow and evolve.
...
- If you're unsure, feel free to open an [`issue`](https://github.com/igorskyflyer/npm-strip-md-headings/issues) or discussion to explore the idea.
...
Your contribution helps maintain and improve Strip Markdown Headings — thank you for helping make it better!  
Check out [`SUPPORT.md`](https://github.com/igorskyflyer/npm-strip-md-headings/blob/main/SUPPORT.md) if you need help or want to sponsor its development.
