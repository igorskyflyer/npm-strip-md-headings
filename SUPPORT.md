...
Hello, thank you for using Strip Markdown Headings! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-strip-md-headings/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-strip-md-headings/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-strip-md-headings/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Strip Markdown Headings version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-strip-md-headings/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-strip-md-headings/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Strip Markdown Headings:
...
<div align="center">
  Thank you for using Strip Markdown Headings!
  <br>
